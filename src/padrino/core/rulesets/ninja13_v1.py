"""ninja13_v1 ruleset constants and helpers.

Ruleset: 13 players, 1 Ninja, 1 Mafia Roleblocker, 1 Mafia Goon,
1 Detective, 1 Doctor, 1 Tracker, 1 Watcher, 6 Villagers. MAX_DAYS=5.
"""
...
_ROLE_FAMILY: Final[dict[Role, RoleFamily]] = {
    Role.NINJA: RoleFamily.DECEPTIVE,
