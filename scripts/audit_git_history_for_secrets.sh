...
# prefixes (csk-, lw, sk-, sk-ant-, tp-, Z.AI hex-dot keys, ghp_, gho_)
# plus the populated `*_API_KEY=<value>` shape over generic high-entropy heuristics, because
...
PATTERN='(csk-[A-Za-z0-9_-]{20,}|lw[A-Za-z0-9_-]{30,}|sk-ant-[A-Za-z0-9_-]{32,}|sk-[A-Za-z0-9_-]{32,}|tp-[A-Za-z0-9_-]{20,}|[A-Fa-f0-9]{32}\.[A-Za-z0-9]{16}|ghp_[A-Za-z0-9]{36,}|gho_[A-Za-z0-9]{36,}|[A-Z][A-Z0-9_]*_API_KEY=[A-Za-z0-9_.-]{20,})'
